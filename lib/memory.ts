// lib/memory.ts — JARVIS v7.0 (Universal Sync/Async Fix)
export const KEYS = {
  CHATS: 'jarvis_chats',
...
// ━━━ THE FIX: Making functions both Sync and Fake-Async ━━━

// यह साधारण तरीके से डेटा देगा (Sync)
export function getBadges(): Badge[] {
  return lsGet(KEYS.BADGES, []);
}

// यह Promise की तरह डेटा देगा (Async) - ताकि .then() फेल न हो
